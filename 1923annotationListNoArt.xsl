...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:param name="canvasURI" select="'https://iiif.archivelab.org/iiif/catalogofcopy201libr$9/canvas'" />
    <!--
    ...
    <xsl:param name="manifestURI" select="'https://iiif.archivelab.org/iiif/catalogofcopy201libr/manifest.json'"/>
